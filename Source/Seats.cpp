...
// ------------------------------------------------------
//  GLOBALNE PROMENLJIVE – dostupne i u main-u
// ------------------------------------------------------
std::vector<Seat> seats;

// ------------------------------------------------------
//  KONFIGURACIJA BIOSKOPSKE SALE
// ------------------------------------------------------
const int NUM_ROWS = 6;
const int NUM_COLS = 14;

const float SEAT_W = 0.17f;   // osnovna širina sedišta
const float SEAT_H = 0.17f;   // osnovna visina sedišta


// ------------------------------------------------------
//  Skaliranje sedišta po redu (bliži red = veæe)
// ------------------------------------------------------
...
// ------------------------------------------------------
//  Inicijalizacija rasporeda sedišta
// ------------------------------------------------------
void initSeats()
{
    seats.clear();
...
// ------------------------------------------------------
//  Klik na sedište ? toggle Free / Reserved
// ------------------------------------------------------
void handleSeatClick(float ndcX, float ndcY)
{
    for (int i = 0; i < (int)seats.size(); i++)
    {
            ...
            ndcY > s.y - seatHeight / 2 && ndcY < s.y + seatHeight / 2)
        {
            ...
            return; // pronašli smo sedište, više ne tražimo
        }
    }
}
...
// ------------------------------------------------------
//  Kupovina N uzastopnih sedišta u nekom redu
// ------------------------------------------------------
void buySeats(int N)
{
